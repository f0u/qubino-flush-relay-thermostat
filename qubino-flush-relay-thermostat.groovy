 ...
 *  2020-03-04 - Trying to convert to Hubitat
 *
 */
metadata {
  ...
  tiles(scale: 2) {
    multiAttributeTile(name:"switch", type:"thermostat", width:6, height:4, canChangeIcon: false) {
      ...
      tileAttribute("device.thermostatMode", key: "THERMOSTAT_MODE") {
        attributeState("off", label: "off", icon: "he.thermostat.heating-cooling-off")
        attributeState("heat", label: "heat", icon: "he.thermostat.heat")
    ...
    standardTile("mode", "device.thermostatMode", inactiveLabel: false, decoration: "flat", width: 2, height: 2) {
      state "off", action: "on", icon: "he.thermostat.heating-cooling-off"
      state "heat", action: "off", icon: "he.thermostat.heat"
    }
    ...
    standardTile("toggleDesiredSetpoint", "device.combinedStateAndTemperature", inactiveLabel: false, decoration: "flat", width: 2, height: 2) {
      state "default", label:'-', icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff", defaultState: true

      state "off-4",  label:'4°',  action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-5",  label:'5°',  action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-6",  label:'6°',  action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-7",  label:'7°',  action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-8",  label:'8°',  action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-9",  label:'9°',  action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-10", label:'10°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-11", label:'11°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-12", label:'12°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-13", label:'13°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-14", label:'14°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-15", label:'15°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-16", label:'16°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-17", label:'17°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-18", label:'18°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-19", label:'19°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-20", label:'20°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-21", label:'21°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-22", label:'22°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-23", label:'23°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-24", label:'24°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-25", label:'25°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-26", label:'26°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-27", label:'26°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-28", label:'28°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-29", label:'29°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-30", label:'30°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-31", label:'31°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-32", label:'32°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-33", label:'33°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-34", label:'34°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-35", label:'35°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-36", label:'36°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-37", label:'37°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-38", label:'38°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-39", label:'39°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      state "off-40", label:'40°', action:"on", icon: "he.thermostat.heating-cooling-off", backgroundColor: "#ffffff"
      ...
      state "heating-4",  label:'4°',  action:"off", icon: "he.thermostat.heating", backgroundColor: "#153591"
      state "heating-5",  label:'5°',  action:"off", icon: "he.thermostat.heating", backgroundColor: "#153591"
      state "heating-6",  label:'6°',  action:"off", icon: "he.thermostat.heating", backgroundColor: "#153591"
      state "heating-7",  label:'7°',  action:"off", icon: "he.thermostat.heating", backgroundColor: "#153591"
      state "heating-8",  label:'8°',  action:"off", icon: "he.thermostat.heating", backgroundColor: "#153591"
      state "heating-9",  label:'9°',  action:"off", icon: "he.thermostat.heating", backgroundColor: "#1e9cbb"
      state "heating-10", label:'10°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#1e9cbb"
      state "heating-11", label:'11°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#1e9cbb"
      state "heating-12", label:'12°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#1e9cbb"
      state "heating-13", label:'13°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#1e9cbb"
      state "heating-14", label:'14°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#1e9cbb"
      state "heating-15", label:'15°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#1e9cbb"
      state "heating-16", label:'16°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#ffa81e"
      state "heating-17", label:'17°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#ffa81e"
      state "heating-18", label:'18°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#ffa81e"
      state "heating-19", label:'19°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#ffa81e"
      state "heating-20", label:'20°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#ffa81e"
      state "heating-21", label:'21°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#ffa81e"
      state "heating-22", label:'22°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#ffa81e"
      state "heating-23", label:'23°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#ffa81e"
      state "heating-24", label:'24°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#ffa81e"
      state "heating-25", label:'25°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#ffa81e"
      state "heating-26", label:'26°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#d04e00"
      state "heating-27", label:'26°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#d04e00"
      state "heating-28", label:'28°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#d04e00"
      state "heating-29", label:'29°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#d04e00"
      state "heating-30", label:'30°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#d04e00"
      state "heating-31", label:'31°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#bc2323"
      state "heating-32", label:'32°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#bc2323"
      state "heating-33", label:'33°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#bc2323"
      state "heating-34", label:'34°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#bc2323"
      state "heating-35", label:'35°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#bc2323"
      state "heating-36", label:'36°', action:"off", icon: "he.thermostat.heating", backgroundColor: "#bc2323"
    }
...
def zwaveEvent_old(hubitat.zwave.commands.basicv1.BasicReport cmd)
{
  def events = []
